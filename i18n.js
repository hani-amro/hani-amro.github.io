...
(function () {
  ...
  var AR = {
    /* ---------- hero ---------- */
    "sz-aria": "بدّل بين حقلٍ بيخبّي العطل وحقلٍ بيعلنه",
    "sz-silent": "صامت",
    "sz-loud": "عالي الصوت",
    "sz-caps": "حسبة فشلت، فصارت صفر. والصفر بيشبه أي رقم تاني، فما في شي بيدلّ عليه — وما بتعرف إنّه صار شي أصلاً.",
    "sz-capl": "نفس العطل، معلَن: بيطلع لقدّام وبيحمل لونه، وبيغور كل شي غيره.",
    "sz-both": "الحقلين فيهن نفس العطل. واحد فيهن بيوريك ياه.",
    /* ---------- البوّابة ---------- */
    "g-eyebrow": "مهندس أنظمة · بالعربية والإنجليزية",
    "g-lede": "ببني أنظمة بتمسك مصاري وطلبات وبيانات زباين — وبتضلّ شغّالة وما حدا مراقبها.",
    "g-d1-h": "عندي شركة",
    "g-d1-p": "إنت بتعرف شو لسّا فريقك بيعمله بالإيد. هون كيف بيمشي الشغل من أول مكالمة للتسليم — وشو ما بستلمه.",
    "g-d1-go": "شو بقدر أبنيلك",
    "g-d2-h": "أنا تقني",
    "g-d2-p": "ستّة أنظمة. الآلية اللي بتخلّي كل واحد آمن، والكود اللي بيفرضها، وروابط شغّالة بتقدر تفتحها هلق — وكل رقم جنبه الأمر اللي طلّعه، حتى اللي صفر.",
    "g-d2-go": "الهندسة",
    "g-rule": "الصفحة التقنية ماشية على قاعدة وحدة: ما في رقم بلا الأمر اللي طلّعه.",
    "g-back": "المدخلان",
    ...
    "m-src": "المصدر",
    "m-w0": "اختباراً يمرّ بالتشغيل الفعلي (205 في apps/api عبر 8 ملفات + 118 في packages/money عبر 6)",
    "m-w1": "تغطية فروع على packages/money — 62/62 فرعاً، وهي بوابة بناء لا تقرير",
    "m-w2": "حكم بوابة الإطلاق التي كتبها على مشروعه نفسه: 15 بنداً مستوفى من 57 (ثم 21 بعد إغلاق ستة)",
    "m-q0": "اختبار نجح بتشغيل فعلي — من 567 حالة في 77 ملف؛ 132 محجوبة بحرّاس بيئة، و1 حارس يفشل عمداً",
    "m-q1": "جدولاً تحت ENABLE + FORCE RLS في الهجرات، من 42 جدولاً في السكيما",
    "m-q2": "طلب وصل مرحلة التسليم — الطلبات الأربعة كلها ما زالت confirmed",
    "m-g0": "اختبار ناجح — كلها على SQLite في الذاكرة، والإنتاج PostgreSQL 16",
    "m-g1": "اختبار عزل بين المستأجرين — 13 على مستوى الـORM و14 على مستوى HTTP",
    "m-g2": "دخل مؤكَّد من 5 دفعات دفعها مشتركان اثنان (⁦145$⁩ + ⁦95$⁩)، آخرها 2026-07-27",
    "m-y0": "اختباراً في 16 ملفاً داخل بيئة Cloudflare Workers الحقيقية. شغّلتُ التشغيلة الكاملة خمس مرات: 198/198 في ثلاث، وفي تشغيلتين جرتا تحت حمل متزامن سقط اختبار واحد (test/isolation.test.ts) بانتهاء مهلة 5000ms — وينجح وحده. الرقم صحيح، والثبات ليس كاملاً.",
    "m-y1": "خطأ في فحص الأنواع — TypeScript strict، خروج بصفر",
    "m-y2": "سطر اختبار مقابل 4,106 سطر مصدر في src/ — نسبة 0.84:1",
    "m-a0": "سطر ✅ في مخرَج الاختبارات وصفر ❌ — منها 24 سطر تجميع (23 ملفاً + سطر ختامي)، أي 540 فحصاً مفرداً",
    "m-a1": "أمر تنفيذ مسجَّل في قاعدة الإنتاج (693 ناجح · 276 متخطّى · 27 فاشل · 2 غير مؤكّد)",
    "m-a2": "صفّ ربح مُقدَّر من 998 — لا رقم مخمَّن مخزَّن في القاعدة إطلاقاً",
    "m-t0": "اختبارات tenant-guard الناجحة — تشغيل حي، لا قراءة شارة",
    "m-t1": "اختبارات overfit-stats الناجحة — تشغيل حي",
    "m-t2": "إصدارات منشورة على PyPI للمكتبتين",
    ...
    "k6-t": "مستخرَجتان من نظامين بنيتهما · والحزمتان بصفر مستخدم",
    ...
    "cs-h": "أعمال مختارة",
    "cs-l": "ستّة أنظمة. كل بطاقة تفتح ملفّ حالة: العطل يقع أولاً والآلية التي توقفه، وشاشات حقيقية، وكل رقم مع الأمر الذي أنتجه.",
    "k1-case": "افتح ملفّ الحالة",
    "k2-case": "افتح ملفّ الحالة",
    "k3-case": "افتح ملفّ الحالة",
    "k4-case": "افتح ملفّ الحالة",
    "k5-case": "افتح ملفّ الحالة",
    "k6-case": "افتح ملفّ الحالة",
    "lbl-p": "المشكلة",
    "lbl-a": "ما بنيته",
    "lbl-r": "النتيجة",
    "lbl-pr": "ما يُثبته",
    ...
    "k3-r": "ولا طلب واحد وصل التسليم: أربعة طلبات تجريبية في 20 تموز 2026، ما زالت كلها عند <em>confirmed</em>‏. وخلفها 434 اختباراً يمرّ من 567 — 132 منها خلف حرّاس بيئة ولم تعمل — ولا يرى متجر طلبات متجر آخر، لأن قاعدة البيانات نفسها تمنعه (PostgreSQL Row-Level Security)‏.",
    ...
    "ai-p": "القرار المعماري لي، والمواصفة لي، وحدّ القبول اللي بيسقّط الشغل أو بيمرّره لي؛ والنموذج بيكتب التنفيذ جوّا هالتلاتة. وأنا بتقاس بالشي اللي بيشتغل: منشور ومشغَّل ومراقَب، وأنا اللي بيستلم العطل الساعة تلاتة بالليل.",
    ...
    "r1": "منصّة التوصيل المذكورة أعلاه. 434 اختباراً يمرّ من 567، وعزل على مستوى الصف في 39 جدولاً.",
    ...
    "r6": "26 أداة PDF، وOCR عربي وإنجليزي، ولا شيء يُخزَّن.",
    ...
    /* ---------- footer ---------- */
    "loc2": "ماليزيا",
    "footer": "مكتوب بالعربي والإنجليزي — الاتنين بالإيد."
  };

  // جداول الصفحات المولَّدة (work/<slug>.html) تُحمَّل قبل هذا الملف وتُدمَج هنا،
  // فلا يحمل كل زائر عربيةَ ستّ صفحات ليقرأ واحدة. المولّد: tools/build_work_pages.py
  var extra = window.__i18nExtra;
  if (extra) {
    for (var xk in extra) {
      if (Object.prototype.hasOwnProperty.call(extra, xk)) AR[xk] = extra[xk];
    }
  }
  ...
  var EN_BUILD = {
    ...
    "b5-t": "Part of the ticketing platform &mdash; no link of its own",
    ...
    "b-ct-h": "Let us talk",
    "b-ct-l": "Send me one process your team still does by hand, start to finish. That is all I need to begin.",
  ...
  // يُطبَّق المحلول أياً كان، لا العربية وحدها.
  // الشرط القديم `initial === "ar"` كان يترك صفحةً عربيةَ الـDOM بلا إنجليزية
  // إلى الأبد: من بدّلها إلى الإنجليزية ثم عاد وجدها عربية، وخياره محفوظ
  // ومُهمَل. وapply عديمة الأثر إن وافقت لغةَ الصفحة، وتصحّح عنوان الزرّ.
  apply(initial);
